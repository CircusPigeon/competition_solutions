...
, giving the number of minions in your company. The next 
 lines each describe the temperature preferences of all your minions. The 
-th line consists of two single space separated integers 
 and 
 (
), which denotes that the 
-th minion likes any temperature between 
 and 
, inclusively.
